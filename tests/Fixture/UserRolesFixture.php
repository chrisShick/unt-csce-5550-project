...
class UserRolesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'title' => ['type' => 'string', 'length' => 25, 'null' => false, 'default' => '', 'collate' => 'utf8mb4_general_ci', 'comment' => '', 'precision' => null],
    ...
    public function init(): void
    {
        $this->records = [
            [
                'id' => 'fad666d5-bce4-4cdb-87c7-4d9bc0448163',
                'title' => 'Lorem ipsum dolor sit a',
                'created' => '2021-07-09 03:03:16',
                'modified' => '2021-07-09 03:03:16',
            ],
        ];
        parent::init();
    }
