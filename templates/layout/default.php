...
if (Configure::read('debug')) {
    $this->prepend('css', $this->Html->css(['BootstrapUI.bootstrap', 'paper-dashboard']));
} else {
    $this->prepend('css', $this->Html->css(['BootstrapUI.bootstrap.min', 'paper-dashboard.min']));
}
 ...
 */
if (Configure::read('debug')) {
    $this->prepend('script', $this->Html->script(['BootstrapUI.jquery', 'BootstrapUI.popper', 'BootstrapUI.bootstrap', 'bootstrap-notify', 'chartjs.min','perfect-scrollbar.jquery.min', 'paper-dashboard']));
} else {
    $this->prepend('script', $this->Html->script(['BootstrapUI.jquery.min', 'BootstrapUI.popper.min', 'BootstrapUI.bootstrap.min', 'bootstrap-notify', 'chartjs.min', 'perfect-scrollbar.jquery.min', 'paper-dashboard.min']));
}
